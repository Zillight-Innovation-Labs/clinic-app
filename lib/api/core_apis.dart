...
class CoreServiceApis {
  ...
  static Future<RxList<ServiceElement>> getServiceList({
    ...
    final serviceListRes = ServiceListRes.fromJson(await handleResponse(
      await buildHttpResponse("${APIEndPoints.getServiceList}?per_page=$perPage&page=$page$searchService$catId$sysServiceId$clinicid$docId$isFeature$type$priceMin$priceMax", method: HttpMethodType.GET),
    ));
  ...
  static Future<RxList<Clinic>> getClinics({
    ...
    final clinicsRes = ClinicsRes.fromJson(await handleResponse(await buildHttpResponse("${APIEndPoints.getClinicList}?per_page=$perPage&page=$page$servId$searchClinic", method: HttpMethodType.GET)));
  ...
  static Future<RxList<Doctor>> getDoctors({
    ...
    final doctorListRes = DoctorListRes.fromJson(await handleResponse(await buildHttpResponse("${APIEndPoints.getDoctorList}?per_page=$perPage&page=$page$clncId$servId$searchDoctor", method: HttpMethodType.GET)));
  ...
  static Future<AppointmentDetailRes> getAppointmentDetail({required int appointmentId}) async {
    return AppointmentDetailRes.fromJson(await handleResponse(await buildHttpResponse("${APIEndPoints.getAppointmentDetail}?appointment_id=$appointmentId", method: HttpMethodType.GET)));
  }
