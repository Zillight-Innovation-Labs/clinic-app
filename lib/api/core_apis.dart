...
// import 'package:healthcelerate/screens/clinic/model/clinics_res_model.dart';
...
//       await buildHttpResponse(
//           "${APIEndPoints.getServiceList}?per_page=$perPage&page=$page$searchService$catId$sysServiceId$clinicid$docId$isFeature$type$priceMin$priceMax",
//           method: HttpMethodType.GET),
//     ));
...
//         await buildHttpResponse(
//             "${APIEndPoints.getClinicList}?per_page=$perPage&page=$page$servId$searchClinic",
//             method: HttpMethodType.GET)));
...
//         await buildHttpResponse(
//             "${APIEndPoints.getDoctorList}?per_page=$perPage&page=$page$clncId$servId$searchDoctor",
//             method: HttpMethodType.GET)));
...
//         await buildHttpResponse(
//             "${APIEndPoints.getAppointmentDetail}?appointment_id=$appointmentId",
//             method: HttpMethodType.GET)));
//   }
