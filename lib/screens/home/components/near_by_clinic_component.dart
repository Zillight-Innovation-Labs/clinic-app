...
class NearByClinicComponent extends StatelessWidget {
  NearByClinicComponent({Key? key}) : super(key: key);
                    ...
                    return InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: homeController.currentPage.value == index ? const Color(0xFF6E8192) : const Color(0xFF6E8192).withOpacity(0.5),
                        ),
                      ),
                    );
                  },
