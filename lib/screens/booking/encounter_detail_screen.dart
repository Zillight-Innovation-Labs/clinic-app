...
class EncounterDetailScreen extends StatelessWidget {
          ...
          () => SnapHelperWidget(
            ...
            onSuccess: (encounterDetailRes) {
              return AnimatedScrollView(
                ...
                children: [
                  14.height,
                  const ViewAllLabel(label: "Basic Information", isShowAll: false).paddingOnly(left: 16, right: 8),
                  Container(
                    width: Get.width,
                        ...
                        detailWidget(
                          ...
                          leadingWidget: Row(
                            ...
                            children: [
                              ...
                              Marquee(
                                child: Text(
                                  'Dr. ${encounterDetailCont.encounterDetail.value.doctorName}',
                          ...
                          trailingWidget: Container(
                            ...
                            decoration: boxDecorationDefault(
                              color: encounterDetailCont.encounterDetail.value.status ? lightGreenColor : lightSecondaryColor,
                              borderRadius: radius(22),
                            ),
                            child: Text(
                              encounterDetailCont.encounterDetail.value.status ? 'ACTIVE' : 'CLOSED',
                              style: boldTextStyle(
                                size: 12,
                  ...
                  Column(
                    children: [
                      16.height,
                      const ViewAllLabel(label: "Problems", isShowAll: false).paddingOnly(left: 16, right: 8),
                      Container(
                        width: Get.width,
                  ...
                  Column(
                    children: [
                      16.height,
                      const ViewAllLabel(label: "Observations", isShowAll: false).paddingOnly(left: 16, right: 8),
                      Container(
                        width: Get.width,
                        padding: const EdgeInsets.all(16),
                        decoration: boxDecorationDefault(color: context.cardColor),
                  ...
                  Column(
                    children: [
                      16.height,
                      const ViewAllLabel(label: "Notes", isShowAll: false).paddingOnly(left: 16, right: 8),
                      Container(
                        width: Get.width,
                        padding: const EdgeInsets.all(16),
                        decoration: boxDecorationDefault(color: context.cardColor),
                  ...
                  Column(
                    children: [
                      16.height,
                      const ViewAllLabel(label: "Prescription", isShowAll: false).paddingOnly(left: 16, right: 8),
                      AnimatedWrap(
                        runSpacing: 16,
                                ...
                                Row(
                                  ...
                                  children: [
                                    Row(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Frequency:", style: secondaryTextStyle(size: 12), maxLines: 1, overflow: TextOverflow.ellipsis),
                                        6.height,
                                    ...
                                    Row(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Days:", style: secondaryTextStyle(size: 12), maxLines: 1, overflow: TextOverflow.ellipsis),
                                        6.height,
                  ...
                  Column(
                    children: [
                      16.height,
                      const ViewAllLabel(label: "Other Information", isShowAll: false).paddingOnly(left: 16, right: 8),
                      Container(
                        width: Get.width,
                        padding: const EdgeInsets.all(16),
                        decoration: boxDecorationDefault(color: context.cardColor),
                  ...
                  Column(
                    children: [
                      16.height,
                      const ViewAllLabel(label: "Patient SOAP", isShowAll: false).paddingOnly(left: 16, right: 8),
                      10.height,
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Subjective', style: primaryTextStyle()),
                              8.height,
                              Container(
                                width: Get.width,
                                padding: const EdgeInsets.all(16),
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Objective', style: primaryTextStyle()),
                              8.height,
                              Container(
                                width: Get.width,
                                padding: const EdgeInsets.all(16),
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Assessment', style: primaryTextStyle()),
                              8.height,
                              Container(
                                width: Get.width,
                                padding: const EdgeInsets.all(16),
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Plan', style: primaryTextStyle()),
                              8.height,
                              Container(
                                width: Get.width,
                                padding: const EdgeInsets.all(16),
  ...
  Widget bodyChartWidget() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const ViewAllLabel(label: "Body Chart", isShowAll: false),
        8.height,
        AnimatedWrap(
          listAnimationType: ListAnimationType.None,
          spacing: 16,
