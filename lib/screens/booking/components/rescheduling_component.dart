              ...
              () => SnapHelperWidget(
                ...
                onSuccess: (p0) {
                  if (appointmentDetailCont.slots.isEmpty) {
                    return NoDataWidget(title: 'No time slots available').paddingTop(12);
                  }
...
void handleRescheduleClick({required BuildContext context, required RxBool isLoading, required Rx<AppointmentData> appointmentDetail, required AppointmentDetailController appointmentDetailCont}) {
  serviceCommonBottomSheet(
    ...
    child: BottomSelectionSheet(
      ...
      isEmpty: false,
      noDataTitle: 'Status list is empty',
      noDataSubTitle: 'There are no status listed at the moment. Stay tuned for more options.',
      listWidget: Stack(
        children: [
          ...
          Positioned(
            ...
            child: Obx(
              () => AppButton(
                ...
                disabledColor: appointmentDetailCont.updateBtnVisible.value ? null : appColorSecondary.withOpacity(0.5),
                shapeBorder: RoundedRectangleBorder(borderRadius: radius(defaultAppButtonRadius / 2)),
                onTap: () {
                  showConfirmDialogCustom(
                    context,
                    title: 'Do you want to change the Time Slot of this appointment?',
