    ...
    return AppScaffoldNew(
      ...
      body: Column(
        ...
        children: [
          ...
          ViewAllLabel(
            label: "Available Clinics for ${clinicListCont.service.value.name}",
            isShowAll: false,
            maxLines: 1,
            expandedText: true,
                ...
                return AnimatedListView(
                  ...
                  emptyWidget: SingleChildScrollView(
                    child: NoDataWidget(
                      ...
                      subTitle: 'Looks like there is no clinic for this service, We\'ll keep you posted when there\'s an update.',
