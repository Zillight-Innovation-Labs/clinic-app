        ...
        () => SnapHelperWidget(
          ...
          onSuccess: (data) {
            if (galleryListCont.galleryList.isEmpty) {
              return NoDataWidget(
                title: 'No Gallery found at a moment',
                subTitle: 'Looks like there is no gallery for this clinic, We\'ll keep you posted when there\'s an update.',
