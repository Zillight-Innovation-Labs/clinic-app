      ...
      body: AnimatedScrollView(
        ...
        children: [
          Column(
            ...
            children: [
              Text("About", style: boldTextStyle(size: 16)),
              16.height,
              Container(
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("Contact Info", style: boldTextStyle(size: 16)),
              16.height,
              Container(
                padding: const EdgeInsets.all(16),
                decoration: boxDecorationDefault(color: context.cardColor),
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("Specialization", style: boldTextStyle(size: 16)),
              16.height,
              Container(
                padding: const EdgeInsets.all(16),
                decoration: boxDecorationDefault(color: context.cardColor),
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("Experience", style: boldTextStyle(size: 16)),
              16.height,
              Container(
                padding: const EdgeInsets.all(16),
                decoration: boxDecorationDefault(color: context.cardColor),
