...
//                 doctorDetailCont.doctorData.value.services[index];
//             return DoctorServiceCard(serviceElement: serviceElement)
//                 .paddingBottom(16);
//           },
//           onNextPage: () async {
//             if (!doctorDetailCont.isServicesLastPage.value) {
//               doctorDetailCont
//                   .servicesPage(doctorDetailCont.servicesPage.value + 1);
//               doctorDetailCont.getServiceList();
//             }
//           },
