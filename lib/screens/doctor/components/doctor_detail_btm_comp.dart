      ...
      child: Column(
        children: [
          SettingItemWidget(
            ...
            subTitle: "Experience, Specialization, Contact Info",
          ...
          Obx(
            () => SettingItemWidget(
              title: "Services",
              decoration: boxDecorationDefault(),
              subTitle: doctorDetailCont.doctorData.value.totalServices != 0
                  ? "Total ${doctorDetailCont.doctorData.value.totalServices} services available"
          ...
          Obx(
            () => SettingItemWidget(
              title: "Reviews",
              decoration: boxDecorationDefault(),
              subTitle: doctorDetailCont.doctorData.value.totalReviews != 0
                  ? "Total ${doctorDetailCont.doctorData.value.totalReviews} reviews"
          ...
          SettingItemWidget(
            title: "Qualification",
            decoration: boxDecorationDefault(),
            subTitle: "Qualification in detail",
            splashColor: transparentColor,
            onTap: () {
