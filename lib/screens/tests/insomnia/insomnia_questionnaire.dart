...
List<String> testQuestion = [
  "I have difficulty falling sleep",
  "Thoughts race through my mind and this prevents me from sleep",
  "I feel afraid to go to sleep",
  "I wake up during the night and can't go back to sleep",
];

class InsomniaTestQuestionnaire extends StatefulWidget {
  const InsomniaTestQuestionnaire({super.key});

  @override
  InsomniaTestQuestionnaireState createState() =>
      InsomniaTestQuestionnaireState();
}

class InsomniaTestQuestionnaireState extends State<InsomniaTestQuestionnaire> {
            ...
            Padding(
              ...
              child: AppButton(
                ...
                onTap: () {
                  if (isOptionSelected) {
                    if (isLast) {
                      // provider.addTest(provider.insomniaTestId, context);
                    }
                    _increaseCount();
