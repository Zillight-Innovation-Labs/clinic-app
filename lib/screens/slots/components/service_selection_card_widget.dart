              ...
              children: [
                ...
                Marquee(
                  child: Row(
                    ...
                    children: [
                      if (serviceElement.discount) PriceWidget(price: serviceElement.payableAmount, size: 18).paddingRight(6),
                      PriceWidget(
                        price: serviceElement.charges,
                        isLineThroughEnabled: serviceElement.discount ? true : false,
                        size: serviceElement.discount ? 14 : 18,
                        color: serviceElement.discount ? textSecondaryColorGlobal : appColorPrimary,
                      ),
