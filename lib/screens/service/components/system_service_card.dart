...
class SystemServiceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SettingItemWidget(
      ...
      subTitle: 'Total ${systemServiceElement.totalServices} services available',
      ...
      onTap: () {
        ...
        log('CURRENT SELECTED SYSTEM SERVICE ID==> ${selectedSysService.value.id}');
        log('CURRENT SELECTED SYSTEM SERVICE NAME==> ${selectedSysService.value.name}');
